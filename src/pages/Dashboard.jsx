      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card bg-purple-50 border border-purple-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-2xl font-semibold text-purple-800">{completedTodos.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-purple-50 border border-purple-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-sm font-medium text-purple-600">Pending Todos</h3>
              <p className="mt-1 text-2xl font-semibold text-purple-800">{pendingTodos.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-purple-50 border border-purple-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-2xl font-semibold text-purple-800">{completionRate}%</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card">
          ...
          <div className="h-64">
            <PieChart 
              data={[
                { name: 'Completed', value: completedTodos.length, color: '#8b5cf6' },
                { name: 'Pending', value: pendingTodos.length, color: '#c084fc' }
              ]} 
            />
          </div>
        </div>
